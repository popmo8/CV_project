...
class P1EDataset(Dataset):
    def __init__(self, path, tfm):
        super(P1EDataset).__init__()
...
resnet.load_state_dict(torch.load('./hw1_data/model/p1_pretrain_40_optimal.pt'))
...
train_set = P1EDataset("./hw1_data/p1_data/office/train", tfm=TRANSFORM_IMG)
train_loader = DataLoader(train_set, batch_size=batch_size, shuffle=True, num_workers=8, pin_memory=True)
valid_set = P1EDataset("./hw1_data/p1_data/office/val", tfm=test_tfm)
...
torch.save(model.state_dict(), './hw1_data/model/p1_e.pt')
