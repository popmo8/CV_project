...
if __name__ == '__main__':
    ...
    for num in nums:
        for stage in stages:
            img_path = f'./hw1_data/p2_data/validation/{num}_sat.jpg'
            seg_path = f'./output/{num}_mask_{stage}.png'
            ...
            for c in cs:
                ...
                imageio.imsave(f'./output/overlap_{num}_{stage}.png', np.uint8(img))
